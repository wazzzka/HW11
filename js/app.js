...
for (let i = 0; i < users.length; i++) {
    if (users[i].balance > 2000) {
        ...
        console.log("Користувач:", users[i]);
...
document.write(`<p>Телефонні номери користувачів з балансом більше 2000: ${phoneNumbers}</p>`);
document.write(`<p>Сума всіх балансів користувачів: ${totalBalance}</p>`);